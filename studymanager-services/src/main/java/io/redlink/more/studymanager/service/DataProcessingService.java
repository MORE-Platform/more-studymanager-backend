...
public class DataProcessingService {
    ...
    public List<SimpleDataPoint> getDataPoints(Long studyId, Integer size, Integer observationId, Integer participantId, Instant date) {
        try {
            return elasticService.listDataPoints(studyId, participantId, observationId, toIsoString(date), size);
        } catch (IOException e) {
