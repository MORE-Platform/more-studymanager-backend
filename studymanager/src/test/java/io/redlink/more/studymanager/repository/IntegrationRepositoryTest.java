...
public class IntegrationRepositoryTest {
    ...
    public void testRepositoryCascade() {
        String type = "accelerometer";
        Long studyId1 = studyRepository.insert(new Study().setContactPerson("test").setContactEmail("test")).getStudyId();
        ...
        Long studyId2 = studyRepository.insert(new Study().setContactPerson("test2").setContactEmail("test2")).getStudyId();
