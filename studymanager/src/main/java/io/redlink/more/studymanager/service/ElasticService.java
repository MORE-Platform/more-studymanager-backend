            ...
            for(StringTermsBucket observation : observationBuckets){
                ...
                for(StringTermsBucket participant : participantBuckets){
                    ...
                    participationDataList.add(new ParticipationData(
                            new ParticipationData.Pair(Integer.parseInt(observation.key().stringValue()), null),
                            new ParticipationData.Pair(Integer.parseInt(participant.key().stringValue().substring(12)), null),
                            new ParticipationData.Pair(Integer.parseInt(studyGroupId.key().stringValue().substring(12)), null),
                            true,
